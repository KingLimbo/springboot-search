...
public class LoginController implements ErrorController {
    ...
    public ModelAndView sysIndex() {
        ...
        String menuControl = role.getMenuControl();
        if (StringUtil.isNotBlank(menuControl)) {
            String[] menuArray = menuControl.split(",");
            // 获取菜单列表
            List<Menu> menuList = menuService.getMenuLeft(menuArray);
