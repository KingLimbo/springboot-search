...
import com.limbo.search.common.*;
import com.limbo.search.sys.po.*;
import com.limbo.search.sys.service.BranchService;
...
public class UserController {
    ...
    public @ResponseBody
    BasePageData uploadImg(@RequestParam("file") MultipartFile file, HttpServletRequest request, HttpServletResponse response) {
        BasePageData data = new BasePageData();
        try {
