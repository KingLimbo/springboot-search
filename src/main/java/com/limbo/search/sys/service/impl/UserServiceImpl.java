...
import com.limbo.search.sys.dao.UserDao;
import com.limbo.search.sys.po.Key;
import com.limbo.search.sys.po.Log;
...
public class UserServiceImpl implements UserService {
    ...
    /* 根据当前登陆用户名查询当前用户id
     * (non-Javadoc)
     * @see com.limbo.search.service.UserService#selectUsersByUname(java.lang.String)
     */
    @Override
