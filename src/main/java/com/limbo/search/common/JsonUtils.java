...
public class JsonUtils {
	...
	public static String getMapJson(Map<Object,Object> map){
	...
	public static void main(String[] args) {
		          ...
		          smallMap.put("userId", "438");
		          smallMap.put("name", "张三");
		          smallMap.put("sex", "男");
		          smallMap.put("reason", "原因"); 
		         String s = getMapJson(smallMap);
